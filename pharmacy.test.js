    ...
    describe('Special cases', () => {
        ...
        describe('Magic Pill', () => {
            it('should not change benefit and expiresIn', () => {
                ...
                expect(new Pharmacy([new Drug('Magic Pill', 10, 50)]).updateBenefitValue()).toEqual(
                    [new Drug('Magic Pill', 10, 50)]
                );
            });
        });
        ...
        describe('Fervex', () => {
            ...
            it('should not change benefit', () => {
                expect(new Pharmacy([new Drug('Fervex', 25, 50)]).updateBenefitValue()).toEqual(
                    [new Drug('Fervex', 24, 50)]
                );
            });
        });
