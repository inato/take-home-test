import runTrial from '.';
import { Pharmacy } from '../pharmacy';
import { drugsWithoutDafalgan } from '../drugs/fixtures';

describe('#runTrial', () => {
  it('should return all drugs without dafalgan after 30 days', () => {
    const originalLoop = runTrial(new Pharmacy(drugsWithoutDafalgan));
    expect(originalLoop).toMatchInlineSnapshot(`
Array [
